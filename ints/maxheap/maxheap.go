...
func NewWithCapacity(capacity int) (h *MaxHeap) {
	// TODO: balk if this is not a power of two; no, just round to next nearest power of two
	h = new(MaxHeap)
	h.data = make([]int, capacity, capacity)
	h.capacity = capacity
	h.size = 0
	return h
}
